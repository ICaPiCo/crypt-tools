...
#name = "hello"
#functio = lambda x: f"hello {x}"
#print(functio(name))
#GLOBAL VARIABLES
alphabet=list(r"""AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtU"uVvWwXxYyZz 1234567890°+&é'(-è_çà)=~\#{[`\\^@]}¨£%µ>?./§^$ù*<,;:!€²âêîûôäëïöüÂÊÎÔÛÄËÏÖÜ—‘’“”œ«»""")
...
def decipherLoop(lenOfKey,message):
    ...
    if maxScore<7:
        ...
        for i in keyCombinations:
            print("Attempting combination:",nbCombinations,"out of:",5**lenOfKey)
            nbCombinations += 1
